...
$kata = "
		...
		a.status_kirim, b.nama_analisis, c.nama, c.instansi, c.alamat_instansi, c.telp, d.nama_sp
        from 
        	tborder as a inner join jenis_analisis as b inner join user as c inner join surat_permohonan as d
        where 
        	a.kode_analisis = b.kode_analisis and c.kode_user = a.kode_user and b.kode_sp = d.kode_sp and a.kode_order = '$syarat'
	";
//var_dump($kata)	;die();
...
<hr>
<h5 style="text-align:center;margin-bottom:0px;">PERMOHONAN ANALISIS <?php echo strtoupper($nama_sp);?> TANAH</h5>
<h5 style="text-align:center;margin-top:0px;margin-bottom:20px;">No. Order : <b style="color:#34495e;"><?php echo substr($kode_order, 6, 6);?></b>/LP Balittanah/<b style="color:#34495e;"><?php echo substr($kode_order, 3, 2);?></b>/20<b style="color:#34495e;"><?php echo substr($kode_order, 0, 2);?></b></h5>
<table>
	<tr>
...
$pdf->WriteHTML($html);
$pdf->Output('PermohonanPenelitianMineralogi_'.$nama.'.pdf');
?>
