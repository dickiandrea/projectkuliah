...
$kata = "
		...
		d.id_order = a.id and c.kode_user = a.kode_user and a.tanggal_terima between '$tanggal_awal' and '$tanggal_akhir' and a.kode_analisis like 'B%' order by a.tanggal_terima asc
	";
...
<div style="sans-serif;text-overflow:ellipsis;">	
	...
	<h4 style="margin-bottom:0px;text-align:center;">REKAP DATA PENELITIAN BIOLOGI</h4>
