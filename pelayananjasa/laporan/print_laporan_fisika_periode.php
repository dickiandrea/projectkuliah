...
$kata = "
		...
		d.id_order = a.id and c.kode_user = a.kode_user and a.tanggal_terima between '$tanggal_awal' and '$tanggal_akhir' and a.kode_analisis like 'F%' order by a.tanggal_terima asc
	";
//var_dump($kata);die();
...
<div style="sans-serif;text-overflow:ellipsis;">	
	...
	<h4 style="margin-bottom:0px;text-align:center;">REKAP DATA PENELITIAN FISIKA</h4>
	...
	<table cellspacing="0" border="1px">
		<thead style="vertical-align:middle;text-align: center;">
			<tr>
				...
				<th rowspan="2" style="width:80px;">Kode<br><small>Jenis Analisis</small></th>
...
$pdf->WriteHTML($html);
ob_end_clean();
$pdf->Output('LaporanPenelitianFisikaPeriode_'.Convert::convert_tanggal($tanggal_awal).'-'.Convert::convert_tanggal($tanggal_akhir).'.pdf');
?>
