...
$kata = "
		select 
			...
			a.contoh_tanaman, a.contoh_pupuk, a.contoh_air, a.contoh_ring, a.contoh_bulk, a.desa, a.status_penelitian,a.metode_kirim,
		...
		where 
			...
			between '$tanggal_awal' and '$tanggal_akhir' and e.pengambilan ='' and e.contoh != '' and e.bayar!='' and e.kaji_ulang !='' and (e.selesai <= now())
		order by 
...
<div style="sans-serif;text-overflow:ellipsis;">	
	...
	<h4 style="margin-bottom:0px;text-align:center;">REKAP DATA YANG BELUM DI AMBIL</h4>
