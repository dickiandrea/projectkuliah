 ...
 <div class="page-title">
  <div class="title_left">
	<h3>Daftar Pengguna <small> Laboratorium</small></h3>
  </div> 
</div>
	  ...
	  <form class="form-horizontal form-label-left" novalidate="" action="?page=input_admin" method="post">
		  ...
		  <div class="item form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<?php
					$data = "select kode_akses, jenis_akses from hak_akses where jenis_akses like '%Laboratorium%'";
		  ...
		  <div class="form-group">
			<div class="col-md-6 col-md-offset-3">
				<input class="btn btn-primary" type="hidden" name="tambah" value="data_admin_lab">
	...
	<div class="x_panel">
	  ...
	  <div class="x_content">
		...
		<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
		  ...
		  <tbody>
			<?php
				$query = "select a.nama_admin, a.email, a.no_hp, a.kode_admin, b.jenis_akses from admin as a inner join hak_akses as b where a.kode_akses = b.kode_akses and a.kode_akses like 'L%'";
				//var_dump($query);
				...
				while($data = $result->fetch_assoc())
				{
					echo "<tr>
							  ...
							  <td>".$data['no_hp']."</td>
							  <td>
								<a href=\"?page=update_admin_lab&kode_admin=".$data['kode_admin']."&set=update\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-pencil\"></i> Edit </a>
								<a onclick=\"return confirm('Apakah anda yakin ingin menghapus ini?');\" href=\"?page=update_admin_lab&kode_admin=".$data['kode_admin']."&set=delete\" class=\"btn btn-danger btn-xs\"><i class=\"fa fa-trash-o\"></i> Delete </a>
							  </td>
						</tr>";
				}
			?>
