...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content">		
		<p>Berikut ini adalah daftar data lampiran Analisis Pengujian. Data ini menjadi dasar data poin-poin penelitian untuk diberikan kepada pihak lab agar mereka bisa meneliti sesuai dengan apa yang diminta.</p>
			...
			<?php
				...
				while($data = $result->fetch_assoc())
				{
					echo "<tr>
							  ...
							  <td>
								<a href=\"?page=update_jenis_analisis&kode_analisis=".$data['kode_analisis']."&set=update\" class=\"btn btn-info btn-sm\"><i class=\"fa fa-pencil\"></i> Edit </a>
								<a onclick=\"return confirm('Apakah anda yakin ingin menghapus ini?');\" href=\"?page=update_jenis_analisis&kode_analisis=".$data['kode_analisis']."&set=delete\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-trash-o\"></i> Delete </a>
							  </td>
						</tr>";
				}
			?>
