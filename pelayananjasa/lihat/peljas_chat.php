	  ...
	  <div class="x_content">
		...
		<div class="container-mailbox">
			...
			<div class="col-lg-3 col-md-4 padding-0" style="padding-left:0px;margin-left:-20px;">
				<input type="hidden" id="kode_refresh" value="0">
				<input type="hidden" name="penerimachat" id="penerimachatadmin" value="0">
				<?php 
					$sessionadmin = @$_SESSION['kdadmin1'];
					$kata = "select kode_admin from admin where kode_admin = '$sessionadmin'";
					$result = $mysqli->query($kata);
					if($result->num_rows > 0)
					{
						while($data = $result->fetch_assoc()){
						   $pengirim = $data['kode_admin'];
					   }
					}else{
						$pengirim = 0;
					}
				?>
				<input type="hidden" name="pengirim" id="pengirim" value="<?php echo $pengirim;?>">
					...
					$kata = "						
						select c.pengirim,c.penerima as kode_admin, a.nama_admin, a.email, c.isi,  c.tanggal, c.tampil from admin as a
							join 
								...
								FROM chatadmin where keterangan ='peljas'
								GROUP BY penerima)
							b
							JOIN 
							chatadmin as c
							on
							(b.penerima = '$pengirim' or b.penerima = a.kode_admin) and (b.pengirim = '$pengirim' or a.kode_admin = b.pengirim) and b.tanggal=c.tanggal and ( c.tampil = '' or c.tampil = 'ya')
							order by c.tampil
						";						
					$result = $mysqli->query($kata);					
					while($data = $result->fetch_assoc()){	
						...
						<?php
								...
								?>		
							<li>
							  <a href="#" onclick="openchatadmin(0);"  class="item clearfix">
								<img src="../images/logo/balittanah.png" alt="balittanah" class="img img-circle ">
								<span class="from">Kepala Balittanah</span>
								<p>Balittanah</p>
								<span class="date"><?php echo $tglakhir;?></span>
							  </a>
							</li>
				...
				<form action="?page=input_pesan" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" >
				  ...
				  <div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<?php
							$data = "select kode_admin, nama_admin from admin where kode_akses != 'PL'";
				  ...
				  <div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<input class="btn btn-primary" type="hidden" name="kirim" value="tambah_pesanadminpeljas">
