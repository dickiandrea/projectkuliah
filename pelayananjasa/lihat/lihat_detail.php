...
$kata = "
	select 
	a.total_biaya, a.kode_order, a.tanggal_terima,a.kode_user, a.kode_analisis, a.contoh_tanah, a.contoh_tanaman, a.contoh_pupuk, a.contoh_air, a.contoh_ring, a.contoh_bulk, a.desa, a.kecamatan, a.kabupaten, a.provinsi, a.koordinat, a.pertanyaan, a.total_biaya, b.nama_analisis, c.nama, c.instansi, c.alamat_instansi, c.telp, d.contoh, d.bayar, d.selesai, d.kaji_ulang, e.nama_sp
    from 
    	tborder as a inner join jenis_analisis as b inner join user as c inner join status as d inner join surat_permohonan as e
    where 
    	a.kode_order = d.kode_order and a.kode_analisis = b.kode_analisis and c.kode_user = a.kode_user and a.kode_order = '$syarat' and b.kode_sp= e.kode_sp
";
//var_dump($kata)	;die();
		...
		<div  style="width: 80%; margin:auto !important;">
			<div class="x_panel">
			  <div class="x_title">
				...
				<form action="laporan/print_detail.php" method="post" target="_blank" style="float: right; margin-right: 50px;">
				...
				<a href="?page=lihat_rekap_on_penelitian"><span class="close" title="Close Modal"><i class="fa fa-close"></i></span></a> 
			  ...
			  <div class="x_content">	  
				...
				<div class="row laporan_detail">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<h2>PERMOHONAN ANALISIS <?php echo strtoupper($nama_sp);?></h2>
						<h4>No. Order : <b style="color:#34495e;"><?php echo substr($kode_order, 6, 3);?></b>/LP Balittanah/<b style="color:#34495e;"><?php echo substr($kode_order, 3, 2);?></b>/20<b style="color:#34495e;"><?php echo substr($kode_order, 0, 2);?></b></h4>
					</div>
				</div>
				<div class="row">
