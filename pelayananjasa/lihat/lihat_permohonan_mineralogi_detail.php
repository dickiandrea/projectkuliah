		...
		<div  style="width: 80%; margin:auto !important;">
			<div class="x_panel">
			  <div class="x_title">
				...
				<form action="laporan/print_pengajuan_permohonan_mineralogi.php" method="post" target="_blank" style="float: right; margin-right: 50px;">
			  ...
			  <div class="x_content">	  
				...
				<div class="row laporan_detail">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<h2>PERMOHONAN ANALISIS MINERALOGI TANAH</h2>
