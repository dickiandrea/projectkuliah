...
<div class="page-title">
  <div class="title_left">
	<h3>Data Progres Pengujian <small> Fisika</small></h3>
  </div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content" style="margin-top:20px;">		
		<p>Berikut ini adalah data progres pengujian fisika.</p>
		<!-- start project list -->
		<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap table-konfirmasi" cellspacing="0" width="100%">
		  ...
		  <tbody id="hasilfilter">
			<?php
				...
				where 
					a.kode_order = c.kode_order and a.kode_user = b.kode_user and a.kode_analisis like 'F%' 
				...
				if($angka>0)
				{
					...
					echo "	
							  <td align=\"center\">
								<a href=\"?page=lihat_proses_fisika_detail&kode_order=".$data['kode_order']."\" class=\"btn btn-info btn-sm\"><i class=\"fa fa-file-text-o\"></i> Lihat Detail</a>
							  </td>
						</tr>";
					}
				}else{
