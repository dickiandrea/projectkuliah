		...
		<div class="col-xs-12 col-md-10 col-md-offset-1">
			<form method="post" action="">
				...
				<?php include "koneksi.php";
						$query_analisis = mysqli_query($connect, "SELECT* FROM jenis_analisis WHERE kode_analisis = 'KThR' ");
				...
				<hr>
				<h3>4. Parameter Penelitian Analisis Kimia Tanah Rutin</h3>
				<div class="row">
						...
						<table class="table" width="100%" cellpadding="2"  cellspacing="3" align="center">
							...
							$no=1;
							$tmp = "salah";
							$select = mysqli_query($connect, "SELECT* FROM pertanyaan WHERE kode_analisis = 'KThR'");
