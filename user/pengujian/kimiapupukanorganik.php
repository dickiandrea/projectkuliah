	...
	<div class="row">
		<div class="col-xs-12 col-md-10 col-md-offset-1">
			<form method="post" action="">
				<h2><font color="#23d96d">Permohonan Analisis Kimia Pupuk Anorganik</font></h2>
				<hr>
				<?php include "koneksi.php";
						$query_analisis = mysqli_query($connect, "SELECT* FROM jenis_analisis WHERE kode_analisis = 'KPa' ");
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-6">
						<div class="form-group">
							<h4> <b> Contoh Pupuk Anorganik </b> </h4>
								<input type="number" name="contoh_pupuk_anorganik" class="form-control input-lg" placeholder="Masukkan jumlah contoh" required>
						</div>
					</div>
				</div>
...
if(isset($_POST['submit']))
		{
			...
			$contoh_pupuk_anorganik = addslashes($_POST['contoh_pupuk_anorganik']);
