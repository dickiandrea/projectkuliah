	...
	<div class="row">
		<div class="col-xs-12 col-md-10 col-md-offset-1">
			<form method="post" action="">
				<h2><font color="#23d96d">Permohonan Analisis Fisika Tanah</font></h2>
				<hr>
				<?php include "koneksi.php";
						$query_analisis = mysqli_query($connect, "SELECT* FROM jenis_analisis WHERE kode_analisis = 'FT' ");
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
							<h4> <b>  Jumlah Contoh Ring* </b> </h4>
								<input type="number" name="contoh_ring" class="form-control input-lg" placeholder="Masukkan jumlah contoh" required>
						</div>
					</div>
					<div class="col-xs-6">
						<div class="form-group">
							<h4> <b>  Jumlah Contoh Bulk* </b> </h4>
								<input type="number" name="contoh_bulk" class="form-control input-lg" placeholder="Masukkan jumlah contoh" required>
						</div>
					</div>
				</div>
				...
				<div class="row">
						...
						<table class="table" width="100%" cellpadding="2"  cellspacing="3" align="center">
							...
							$no=1;
							$tmp = "salah";
							$select = mysqli_query($connect, "SELECT* FROM pertanyaan WHERE kode_analisis = 'FT'");
					...
					<hr>
					<a href="?view=pengujian" class="btn btn-theme"> Kembali </a>
				</div>
			</form>
			<script type="text/javascript">
...
if(isset($_POST['submit']))
		{
			...
			$contoh_ring = addslashes($_POST['contoh_ring']);
			$contoh_bulk = addslashes($_POST['contoh_bulk']);
