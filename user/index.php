...
{
	?>
	<script>document.location='userpage.php'</script>
	<?php
}
include "koneksi.php";
?>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">PELAYANAN <i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-3 col-lg-3">
				<div class="widget">
					<h4>Registrasi</h4>
					<p>Untuk melakukan pelayanan jasa, silahkan membuat akun dengan mengisi registrasi akun</p>
                    <div class="form-group multiple-form-group input-group">
                        <a href="?view=register" class="btn btn-theme">REGISTRASI</a>
                    </div>
				</div>
			</div>
		</div>
