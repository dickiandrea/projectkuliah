...
// Keterangan update : ada 3 parameter; 1. Nama table, 2. Kondisi atau syarat, 3. isi menggunakan array	
  ...
  if($result){
	...
	document.location='?page=lihat_pengguna_peljas'; 
    </script><?php
  }
...
if($data == "delete"){
	...
	?>	<script language="JavaScript">
		document.location='?page=lihat_pengguna_peljas'; </script>
	<?php
...
<div  style="width: 80%; margin:auto !important;">
	<div class="x_panel">
	  <div class="x_title">
		...
		<a href="?page=lihat_pengguna_peljas"><span class="close" title="Close Modal"><i class="fa fa-close"></i></span></a> 
