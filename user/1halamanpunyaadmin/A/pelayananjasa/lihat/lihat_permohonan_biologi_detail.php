			...
			<div class="x_panel">
			  <div class="x_title">
				<h2>Lembar Permohonan Penelitian Lengkap</h2>
					<a href="laporan/print_permohonan_biologi_detail.php?kode_order=<?php echo $kode_order;?>" target="_blank"><span style="color:black; line-height: 30px; float: right; margin-right: 50px;" title="Close Modal">print <i class="fa fa-print"></i></span></a> 
			  ...
			  <div class="x_content">	  
				...
				<div class="row laporan_detail">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<h2>PERMOHONAN ANALISIS BIOLOGI</h2>
