		...
		<div  style="width: 80%; margin:auto !important;">
			<div class="x_panel">
			  <div class="x_title">
				...
				<a href="laporan/print_permohonan_fisika_detail.php?kode_order=<?php echo $kode_order;?>" target="_blank"><span style="color:black; line-height: 30px; float: right; margin-right: 50px;" title="Close Modal">print <i class="fa fa-print"></i></span></a> 
