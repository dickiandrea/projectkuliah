	...
	<div class="x_panel">
	  ...
	  <form class="form-horizontal form-label-left" novalidate="" action="?page=input_pelanggan" method="post">
		  ...
		  <div class="item form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
			  <input id="instansi" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="instansi" placeholder="Masukan nama" required="required" type="text">
			</div>
		  </div>
		  <div class="item form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
			  <input id="alamat_instansi" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="alamat_instansi" placeholder="Masukan nama" required="required" type="text">
			</div>
		  </div>
		  <div class="item form-group">
	  ...
	  <div class="x_content">
		...
		<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
		  <thead>
			<tr>
			  <th style="width: 1%">#</th>
			  <th style="width: 20%">Nama<br><small>Perwakilan</small></th>
