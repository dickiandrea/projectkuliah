...
<div class="page-title">
  <div class="title_left">
	<h3>Data Lampiran<small> Surat Permohonan Penelitian</small></h3>
  </div>  
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content">		
		<p>Berikut ini adalah daftar data lampiran surat permohonan penelitian. Data ini menjadi dasar tujuan pengiriman data transaksi ke laboratorium untuk di teliti.</p>
			...
			<?php
				...
				while($data = $result->fetch_assoc())
				{
					echo "<tr>
							  ...
							  <td>
								<a href=\"?page=update_jenis_spermohonan&kode_sp=".$data['kode_sp']."&set=update\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-pencil\"></i> Edit </a>
								<a onclick=\"return confirm('Apakah anda yakin ingin menghapus ini?');\" href=\"?page=update_jenis_spermohonan&kode_sp=".$data['kode_sp']."&set=delete\" class=\"btn btn-danger btn-xs\"><i class=\"fa fa-trash-o\"></i> Delete </a>
							  </td>
						</tr>";
				}
			?>
