			...
			<?php
				...
				while($data = $result->fetch_assoc())
				{
					echo "<tr>
							  ...
							  <td>
								<a href=\"?page=update_hak_akses&kode=".$data['kode_akses']."&set=update\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-pencil\"></i> Edit </a>
								<a onclick=\"return confirm('Apakah anda yakin ingin menghapus ini?');\" href=\"?page=update_hak_akses&kode=".$data['kode_akses']."&set=delete\" class=\"btn btn-danger btn-xs\"><i class=\"fa fa-trash-o\"></i> Delete </a>
							  </td>
						</tr>";
				}
			?>
