...
<div class="page-title">
  <div class="title_left">
	<h3>Data Permohonan Penelitian <small> Fisika</small></h3>
  </div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content" style="margin-top:20px;">		
		<p>Berikut ini adalah daftar data permohonan penelitian fisika.</p>
		<!-- start project list -->
		<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap table-konfirmasi" cellspacing="0" width="100%">
		  ...
		  <tbody id="hasilfilter">
			<?php
				$query = "select a.kode_order, a.tanggal_terima, a.kode_user, b.nama, a.status_kirim, a.status_bayar from tborder as a inner join user as b where a.kode_user = b.kode_user and a.kode_analisis like '%F' order  by a.tanggal_terima ";								
				//var_dump($query);
				...
				if($angka>0)
				{
					...
					echo "<tr>
							  ...
							  if($status_sampel != "belum dikirim"){
								...
								<td align=\"center\" style=\"padding: 10px 15px 3px 15px;\">
									...
									Ubah ke 
									<a onclick=\"return confirm('Ubah menjadi Belum Lengkap?');\" href=\"?page=update_permohonan_fisika&kode_order=".$data['kode_order']."&sampel=belum\" class=\"btn btn-danger btn-xs\" style=\"margin-left:5px;\"><i class=\"fa fa-minus-square\"></i></a>
								</td>";  
							  }else{
								echo "
								<td align=\"center\" style=\"padding: 10px 15px 3px 15px;\">
							  ...
							  if($status_bayar != "belum dibayar"){
								...
								<td align=\"center\" style=\"padding: 10px 15px 3px 15px;\">
									...
									Ubah ke 
									<a onclick=\"return confirm('Ubah menjadi Belum Lunas?');\" href=\"?page=update_permohonan_fisika&kode_order=".$data['kode_order']."&bayar=belum\" class=\"btn btn-danger btn-xs\" style=\"margin-left:5px;\"><i class=\"fa fa-minus-square\"></i></a>
								</td>";  
							  }else{
								echo "
								<td align=\"center\" style=\"padding: 10px 15px 3px 15px;\">
					...
					echo "
							  <td align=\"center\">
								<a href=\"?page=lihat_permohonan_fisika_detail&kode_order=".$data['kode_order']."\" class=\"btn btn-info btn-sm\"><i class=\"fa fa-file-text-o\"></i> Lihat Detail</a>
							  </td>
						</tr>";
					}
				}else{
	...
	<div class="row animate-zoom">
		<div  style="width: 80%; margin:auto !important;">
			<div class="x_panel">
			  ...
			  <div class="x_content">	  
				<form action="?page=update_permohonan_fisika" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" >					
