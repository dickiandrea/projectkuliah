...
<div class="page-title">
  <div class="title_left">
	<h3>Data Permohonan Pengujian <small> Fisika</small></h3>
  </div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<div class="x_panel">
	  ...
	  <div class="x_content" style="margin-top:20px;">		
		<p>Berikut ini adalah daftar data permohonan pengujian fisika.</p>
		<!-- start project list -->
			...
			<?php
				$query = "
					select DISTINCT a.id, a.tanggal_terima, a.kode_user, b.nama, c.contoh, c.bayar, a.kode_analisis
						...
						where 
							c.kode_order = '' and c.nomer_contoh = '' and a.id = c.id_order and (a.kode_user = b.kode_user and a.kode_analisis like 'F%')
						order by 
					...
					echo "<tr>
							  ...
							  if($status_sampel != NULL){
								...
								<td align=\"center\" style=\"padding: 10px 15px 3px 15px;\">
									...
									<small>Ubah ke </small>
									<a onclick=\"return confirm('Ubah menjadi Belum Lengkap?');\" href=\"?page=update_permohonan_fisika&id_order=".$data['id']."&sampel=belum\" class=\"btn btn-danger btn-xs\" style=\"margin-left:5px;\"><i class=\"fa fa-minus-square\"></i></a>
								</td>";  
							  }else{
								echo "
								<td align=\"center\" style=\"padding: 10px 15px 3px 15px;\">
									...
									<small>Ubah ke </small>
									<a href=\"?page=update_permohonan_fisika&id_order=".$data['id']."&update=contoh\" class=\"btn btn-success btn-xs\" style=\"margin-left:5px;\"><i class=\"fa fa-check-square\"></i></a>
								</td>";  
							  }
							  if($status_bayar != NULL){
								...
								<td align=\"center\" style=\"padding: 10px 15px 3px 15px;\">
									...
									<small>Ubah ke </small>
									<a onclick=\"return confirm('Ubah menjadi Belum Lunas?');\" href=\"?page=update_permohonan_fisika&id_order=".$data['id']."&bayar=belum\" class=\"btn btn-danger btn-xs\" style=\"margin-left:5px;\"><i class=\"fa fa-minus-square\"></i></a>
								</td>";  
							  }else{
								echo "
								<td align=\"center\" style=\"padding: 10px 15px 3px 15px;\">
									...
									<small>Ubah ke </small>
									<a href=\"?page=update_permohonan_fisika&id_order=".$data['id']."&update=bayar\" class=\"btn btn-success btn-xs\" style=\"margin-left:5px;\"><i class=\"fa fa-check-square\"></i></a>
								</td>";  
							  }
						if($status_bayar  == NULL or $status_sampel == NULL){
							...
							echo "
									  <td align=\"center\">
										...
										<a href=\"?page=lihat_permohonan_fisika_detail&id_order=".$data['id']."\" class=\"btn btn-info btn-sm\"><i class=\"fa fa-file-text-o\"></i> Lihat Detail</a>
									  </td>
								</tr>";	
						}else{
							...
							echo "
									  <td align=\"center\">
										<a href=\"?page=update_permohonan_fisika&id_order=".$data['id']."&update=berikode\" class=\"btn btn-danger btn-md\">Proses Pengujian</a>
										<a href=\"?page=lihat_permohonan_fisika_detail&id_order=".$data['id']."\" class=\"btn btn-info btn-sm\"><i class=\"fa fa-file-text-o\"></i> Lihat Detail</a>
									  </td>
								</tr>";	
						}
			  ...
			  <div class="x_content">	  
				<form action="laporan/print_laporan_data_periode.php" target="_blank" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="" >					
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input class="btn btn-primary" type="hidden" name="print" value="fisika">
