		...
		<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
		  ...
		  <tbody>
			<?php
				...
				$query = "select kode_admin,nama_admin, email, no_hp, jenis_akses from admin inner join hak_akses where admin.kode_akses = hak_akses.kode_akses";
				...
				while($data = $result->fetch_assoc())
				{
					echo "<tr>
							  ...
							  <td>
								<a href=\"?page=update_pengguna_admin&kode_admin=".$data['kode_admin']."&set=update\" class=\"btn btn-info btn-sm\"><i class=\"fa fa-pencil\"></i> Edit </a>
								<a onclick=\"return confirm('Apakah anda yakin ingin menghapus ini?');\" href=\"?page=update_pengguna_admin&kode_admin=".$data['kode_admin']."&set=delete\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-trash-o\"></i> Delete </a>
							  </td>
						</tr>";
				}
			?>
