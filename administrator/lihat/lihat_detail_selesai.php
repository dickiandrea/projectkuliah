		...
		<div  style="width: 80%; margin:auto !important;">
			<div class="x_panel">
			  <div class="x_title">
				...
				<a href="?page=lihat_rekap_selesai"><span class="close" title="Close Modal"><i class="fa fa-close"></i></span></a> 
				...
				<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
				  ...
				  <tbody>
					<?php
						...
						echo "
							<tr>
								<td colspan='4' style='text-align:center;border-top:1px solid;'>Total Harga </td>
