		...
		<div  style="width: 80%; margin:auto !important;">
			<div class="x_panel">
			  <div class="x_title">
				...
				<form action="laporan/print_pengajuan_permohonan_fisika.php" method="post" target="_blank" style="float: right; margin-right: 50px;">
					<button class="btn btn-success btn-sm" > Print <i class="fa fa-print"></i></button>
					<input type="hidden" class="btn btn-info btn-sm" name="id_order" value="<?php echo $id_order;?>">
				</form>
				<a href="?page=lihat_permohonan_fisika"><span class="close" title="Close Modal"><i class="fa fa-close"></i></span></a> 
			  ...
			  <div class="x_content">	  
				...
				<div class="row laporan_detail">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<h4><i>*Pengujian Belum Di Verifikasi. Silahkan Bayar.*</i></h4>
					</div>
				</div>
				<div class="row">
