		...
		<div  style="width: 80%; margin:auto !important;">
			<div class="x_panel">
			  <div class="x_title">
				...
				<form action="laporan/print_permohonan_biologi_detail.php" method="post" target="_blank" style="float: right; margin-right: 50px;">
				...
				<a href="?page=lihat_proses_biologi"><span class="close" title="Close Modal"><i class="fa fa-close"></i></span></a> 
