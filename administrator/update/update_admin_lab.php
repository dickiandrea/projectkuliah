...
// Keterangan update : ada 3 parameter; 1. Nama table, 2. Kondisi atau syarat, 3. isi menggunakan array	
  ...
  if($result){
	...
	document.location='?page=lihat_pengguna_lab'; 
    </script><?php
  }
...
if($data == "delete"){
	...
	?>	<script language="JavaScript">
		document.location='?page=lihat_pengguna_lab'; </script>
	<?php
...
<div  style="width: 80%; margin:auto !important;">
	<div class="x_panel">
	  <div class="x_title">
		...
		<a href="?page=lihat_pengguna_lab"><span class="close" title="Close Modal"><i class="fa fa-close"></i></span></a> 
	  ...
	  <form class="form-horizontal form-label-left" novalidate="" action="" method="post">
		  ...
		  <div class="item form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
			  <input id="nama" class="form-control col-md-7 col-xs-12" data-validate-words="2" name="nama" placeholder="Masukan nama" required="required" type="text" value="<?php echo $nama_admin;?>">
			</div>
		  </div>
		  <div class="item form-group">
