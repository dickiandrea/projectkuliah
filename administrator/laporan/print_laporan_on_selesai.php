...
$kata = "
		select 
			...
			a.status_kirim, b.nama_analisis, c.nama, c.instansi, c.alamat_instansi, c.telp, e.contoh, e.bayar, e.pengambilan
		from 
			tborder as a inner join jenis_analisis as b inner join user as c inner join surat_permohonan as d inner join status as e 
		where 
			a.kode_order = e.kode_order and 
			a.kode_analisis = b.kode_analisis and c.kode_user = a.kode_user and b.kode_sp =d.kode_sp and a.tanggal_terima 
			between '$tanggal_awal' and '$tanggal_akhir' and e.pengambilan !=''
		order by 
...
<div style="sans-serif;text-overflow:ellipsis;">	
	...
	<h4 style="margin-bottom:0px;text-align:center;">REKAP DATA AKHIR</h4>
	...
	<table cellspacing="0" border="1px">
		<thead style="vertical-align:middle;text-align: center;">
			<tr>
				...
				<th rowspan="2" style="width:120px;">Tanggal<br><small>Diambil SP/LHP</small></th>
			</tr>
			<tr>
			...
			<?php
				...
				if(($result->num_rows) > 0){					
					while($data = $result->fetch_assoc()){
						...
						echo "<td style='text-align:center;vertical-align:middle;'>".$tglpengambil." <br>oleh<br>".$nmpengambil."</td>";				
						echo "</tr>";
						$no++;
					}
				}else{
...
$pdf->WriteHTML($html);
ob_end_clean();
$pdf->Output('LaporanSelesaiPeriode_'.Convert::convert_tanggal($tanggal_awal).'-'.Convert::convert_tanggal($tanggal_akhir).'.pdf');
?>
