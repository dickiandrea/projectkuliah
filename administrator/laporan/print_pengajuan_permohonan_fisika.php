...
$kata = "
		...
		c.kode_user = a.kode_user and a.id = '$syarat'
	";
//var_dump($kata)	;die();
...
<hr>
<h5 style="text-align:center;margin-bottom:0px;">RENCANA PERMOHONAN ANALISIS FISIKA TANAH</h5>
<h5 style="text-align:center;margin-top:0px;margin-bottom:20px;"><i>*Pengujian Belum Di Verifikasi. Silahkan Bayar.*</i></h5>
<table>
	<tr>
		<td>Tanggal Terima</td>
		<td>:</td>
		<td colspan="8" style="font-weight:bold;"><?php echo Convert::convert_tanggal($tanggal_terima);?></td>		
	</tr>
	<tr>
		<td>Jumlah Contoh</td>
		<td>:</td>
		...
		<td>Tanah</td>		
		<td style="width:45px; text-align:center; font-weight:bold;"><?php echo $contoh_bulk;?><hr></td>		
		<td>Bulk</td>	
		<td style="width:45px; text-align:center; font-weight:bold;"><?php echo $contoh_pupuk;?><hr></td>		
		<td>Pupuk</td>		
		<td style="width:45px; text-align:center; font-weight:bold;"><?php echo $contoh_ring;?><hr></td>		
		<td>Ring</td>		
	</tr>
	<tr>
		<td></td>
		...
		<td>:</td>
		<td colspan="4"  style="font-weight:bold;"><?php echo $desa;?></td>		
		<td>Kec.</td>		
		<td>:</td>
	...
	<tr>
		...
		<td>:</td>
		<td colspan="4"  style="font-weight:bold;"><?php echo $kabupaten;?></td>		
		<td>Prov.</td>		
		<td>:</td>
	...
	<tr>
		...
		<td>:</td>
		<td colspan="4"  style="font-weight:bold;"><?php echo $koordinat;?></td>		
		<td></td>		
	</tr>
	<tr>
		<td>Nama Pengirim</td>
...
<table cellspacing="0">
  <thead style="text-align:center;">
	<tr >
	  ...
	  <th style="height:50px; vertical-align:middle; width: 300px;">Jenis<br/><small>Analisis</small></th>
	  <th style="width: 100px;">Tarif *<br/><small>(Rp./Contoh)</small></th>
	  <th style="width: 70px;">Jumlah<br/><small>Contoh</small></th>
	  <th style="width: 70px;">Atur<br/><small>Contoh</small></th>
	  <th style="width: 120px;">Biaya<br/><small>(Rp.)</small></th>
	</tr>
  </thead>
		...
		if(($result->num_rows)>0){
			...
			while($data = $result->fetch_assoc())
			{
				...
				if($tmp != $data['kelompok']){
					echo "<tr>
					  <td style=\"text-align:left;\">";echo $i + 1;echo ".";
					echo "</td>
					  <td style=\"text-align:left;\">".$data['isi_pertanyaan']."</td>			  
					  <td>".$data['tarif']."</td>			  
					  <td>".$jumlahcontoh."</td>
					  <td>".$contoh[$i]."</td>
			...
			echo "
				...
				<tr>
					<td colspan='5' style='text-align:center;border-top:1px solid;padding: 10px 0px;'>Total Harga </td>
...
$pdf->WriteHTML($html);
$pdf->Output('PermohonanPenelitianFisika_'.$nama.'.pdf');
?>
