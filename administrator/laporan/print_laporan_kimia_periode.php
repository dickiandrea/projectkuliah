...
$kata = "
		...
		d.id_order = a.id and c.kode_user = a.kode_user and a.tanggal_terima between '$tanggal_awal' and '$tanggal_akhir' and a.kode_analisis like 'K%' order by a.tanggal_terima asc
	";
	...
	<table cellspacing="0" border="1px">
		<thead style="vertical-align:middle;text-align: center;">
			<tr>
				...
				<th rowspan="2" style="width:110px;">Tanggal<br><small>Terima</small></th>
				<th colspan="6">Contoh Analisis</th>
				<th rowspan="2" style="width:150px;">Lokasi<br><small>Uji</small></th>
				<th rowspan="2" style="width:100px;">Kode<br><small>Jenis Analisis</small></th>
