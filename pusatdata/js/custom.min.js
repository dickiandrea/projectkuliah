function init_sidebar()
{
	...
	$SIDEBAR_MENU.find("a").on("click",function(b){
		...
		$SIDEBAR_MENU.find("li ul").slideUp()):($SIDEBAR_MENU.find("li").removeClass("active active-sm"),$SIDEBAR_MENU.find("li ul").slideUp()),
		c.addClass("active"),$("ul:first",c).slideDown(function(){a()}))}),
...
function init_PNotify()
{
	"undefined"!=typeof PNotify&&(
		...
		new PNotify(
			{
				title:"PNotify",type:"info",text:"Welcome. Try hovering over me. You can click things behind me, because I'm non-blocking.",
				nonblock:{nonblock:!0},
				addclass:"dark",styling:"bootstrap3",
				hide:!1,
				before_close:function(a)
				{
					return a.update({title:a.options.title+" - Enjoy your Stay",before_close:null}),
					a.queueRemove(),!1
				}
			}
		)
	...
	if(console.log("run_customtabs"),"undefined"!=typeof CustomTabs)
	{
		...
		TabbedNotification=function(b)
		{
			...
			$(document).on("click",".notification_close",function(a)
			{
				...
				b=idname.substr(-2),$("#ntf"+b).remove(),
...
function init_EasyPieChart()
{
	if("undefined"!=typeof $.fn.easyPieChart)
	{
		...
		$(".chart").easyPieChart(
		{
			easing:"easeOutElastic",delay:3e3,barColor:"#26B99A",trackColor:"#fff",scaleColor:!1,lineWidth:20,trackWidth:16,lineCap:"butt",
	...
	if(console.log("run_charts  typeof ["+typeof Chart+"]"),"undefined"!=typeof Chart){
		if(console.log("init_charts"),Chart.defaults.global.legend={enabled:!1},$("#canvas_line").length){
			new Chart(document.getElementById("canvas_line"),{
				...
				datasets:[{
					label:"My First dataset",backgroundColor:"rgba(38, 185, 154, 0.31)",
					...
					pointBorderWidth:1,data:[31,74,6,39,20,85,7]},
					{
						...
						pointBorderWidth:1,data:[82,23,66,9,99,4,2]
					}
				]}
			})
		}
	...
	if($("#pieChart").length){
		...
		i={
			datasets:[{
				...
				backgroundColor:["#455C73","#9B59B6","#BDC3C7","#26B99A","#3498DB"],
				label:"My dataset"}],labels:["Dark Gray","Purple","Gray","Green","Blue"]};
			new Chart(f,
			{
				data:i,type:"pie",otpions:{legend:!1}
			})			
	}
			...
			select:function(a,b,c){
				...
				$(".antosubmit").on("click",function(){
					...
					a&&g.fullCalendar("renderEvent",{
						title:a,start:e,end:b,allDay:c},!0),
						$("#title").val(""),
			...
			eventClick:function(a,b,c){
				...
				events:[{
					...
					start:new Date(d,c,1)
						...
						end:new Date(d,c,b,14,0),allDay:!1
					},{
						title:"Birthday Party",
						start:new Date(d,c,b+1,19,0),
						end:new Date(d,c,b+1,22,30),allDay:!1
					},{
...
function init_echarts(){
	...
	if($("#echart_pie2").length){
		...
		h.setOption({
			...
			calculable:!0,series:[{
				name:"Area Mode",type:"pie",radius:[25,90],
				center:["50%",170],roseType:"area",x:"50%",
				max:40,sort:"ascending",
				data:[
					{value:10,name:"rose1"},
					{value:5,name:"rose2"},
					{value:15,name:"rose3"},
