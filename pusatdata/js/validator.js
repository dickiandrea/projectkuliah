...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'input salah',
        checked         : 'harus di ceklis',
        empty           : 'tolong isi sesuatu disini',
        min             : 'input terlalu sedikit',
        max             : 'input terlalu banyak',
        number_min      : 'terlalu rendah',
        number_max      : 'terlalu tinggi',
        url             : 'URL salah',
        number          : 'ini bukan nomer',
        email           : 'ini bukan email',
        email_repeat    : 'email anda tidak sama',
        password_repeat : 'password anda tidak sama',
        repeat          : 'no match',
        complete        : 'input belum selesai',
        select          : 'Tolong pilih sesuatu'
    };
